...
class Partner extends PG {
   ...
   ADD_PARTNER_RU (partner_name, partner_logo, partner_logo_name, partner_status) {
      return this.fetch(`
         INSERT INTO 
                     partner_ru (
                        partner_name,
   ...
   UPDATE_PARTNER_RU (partner_id, partner_name, partner_logo, partner_logo_name, partner_status) {
      return this.fetch(`
         UPDATE
                  partner_ru
         SET
